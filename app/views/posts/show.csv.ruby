...
CSV.generate do |csv|
  csv_column_names = %w(氏名 メール 最寄駅 住所 運営有無 運営期間(年) 運営期間(月) 中途解約金有無 中途解約金 1ヶ月賃料 税区分 土地の状況 駐車可能な台数 駐車場面積 面積単位 利用期間(開始) 利用期間(終了) 希望賃料 その他特記事項(顧客) その他特記事項(社員) 作成日時 更新日時)
